class PageThreeScene extends Scene {
  create() {
    const g = this.game;
    ...
    g.ui.add(new ImageView({ x: BASE_WIDTH / 2 - 300, y: 500, width: 350, height: 100, assets: g.assets, src: 'page_3/empty_word_panel', key: 'empty_word_panel' }));
